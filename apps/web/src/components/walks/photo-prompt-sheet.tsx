      ...
      >
        ...
        <div className="mt-5 flex flex-col gap-2">
          <button
            type="button"
            onClick={onTake}
            className="btn-mango inline-flex h-12 w-full items-center justify-center gap-2 rounded-full text-base font-bold text-white transition-transform active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mango-brand-deep focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
