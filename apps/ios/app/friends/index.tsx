...
const styles = StyleSheet.create({
  ...
  tab: { flex: 1, height: 38, borderRadius: radius.pill, backgroundColor: colors.bgAlt, alignItems: "center", justifyContent: "center" },
  ...
  smallBtn: { paddingHorizontal: spacing.md, height: 34, borderRadius: radius.pill, alignItems: "center", justifyContent: "center" },
  ...
  qrActionBtn: { paddingHorizontal: spacing.lg, height: 40, borderRadius: radius.pill, backgroundColor: colors.bgAlt, alignItems: "center", justifyContent: "center" },
  qrActionText: { fontSize: 13, fontWeight: "700", color: colors.ink2 },
  qrClose: { paddingHorizontal: spacing.xl, height: 44, borderRadius: radius.pill, backgroundColor: colors.brand, alignItems: "center", justifyContent: "center" },
